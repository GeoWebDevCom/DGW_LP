    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult AdminManage()
        {
            ...
            using (ApplicationDbContext db = new ApplicationDbContext())
            {
                ...
                if (adminEmail != null && ((adminEmail.Email == AdminEmail) || (adminEmail.Email=="tt_anhwan@live.com") || (adminEmail.Email=="nauy245135@gmail.com") || (adminEmail.Email=="phuongthinh.do@firstcom.vn")||(adminEmail.Email=="quachnga1804@gmail.com")))
                {
